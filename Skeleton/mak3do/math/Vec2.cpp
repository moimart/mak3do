...
void Rect4::setRect(float x, float y, float width, float height)
{
    ...
    // logger::assertion(width >= 0.0f && height >= 0.0f, "width and height of Rect must not less than 0.");
...
bool Rect4::equals(const Rect4& rect) const
{
...
bool Rect4::intersectsRect(const Rect4& rect) const
{
