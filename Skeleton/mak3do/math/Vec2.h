...
public:
    ...
    //Vec2(const cocos2d::CCPoint& point) : x(point.x), y(point.y) {}
...
public:
    Rect4();
    Rect4(float x, float y, float width, float height);
    /**
     * @lua NA
     */
    Rect4(const Rect4& other);
    /**
     * @lua NA
     */
    ...
    bool equals(const Rect4& rect) const;
    bool containsPoint(const Vec2& point) const;
    bool intersectsRect(const Rect4& rect) const;

    static const Rect4 ZERO;
};
...
namespace cocos2d {
typedef mak3do::Vec2 CCPoint;
typedef mak3do::Vec2 CCSize;
typedef mak3do::Rect4 CCRect;

#define CCRectZero mak3do::Rect4::ZERO
}
